...
Route::group(
    ...
    function () {
        ...
        Route::post(
            'dashboard/coach/report/add/store',
            [Coach_Dashboard::class, 'store']
        )->name('report.store');
        ...
        Route::get(
            'dashboard/player/matches_rating',
            [
                \App\Http\Controllers\Dashboard\Player_Dashboard::class,
                'rating'
            ]
        )->name('player.match_rating');


        Route::get(
            'dashboard/player/compare',
            [
                \App\Http\Controllers\Dashboard\Player_Dashboard::class,
                'compare'
            ]
        ...
        Route::get(
            'dashboard/player/coach_discussion',
            [
                \App\Http\Controllers\Dashboard\Player_Dashboard::class,
                'coach_discussion'
            ]
        ...
        Route::get(
            'dashboard/player/analysis_discussion',
            [
                \App\Http\Controllers\Dashboard\Player_Dashboard::class,
                'analysis_discussion'
            ]
        ...
        Route::get(
            'dashboard/player/club_info',
            [
                \App\Http\Controllers\Dashboard\Player_Dashboard::class,
                'club_info'
            ]
        )->name('player.club_info');


        Route::get(
            'dashboard/player/epl_stats',
            [
                \App\Http\Controllers\Dashboard\Player_Dashboard::class,
                'epl_stats'
            ]
        )->name('player.epl_stats');

        Route::get('dashboard/player/compare', [Player_Dashboard::class, 'compare'])->name('player.compare');

        Route::post(
            '/dashboard/player/comparison',
            [Player_Dashboard::class, 'comparePlayers']
        )->name('comparePlayers');
        ...
        ###########################################################
        Route::get(
            '/checkConvo/{recieverId}',
            [ContactsController::class, 'check']
        )->middleware('auth:coach');
        ###########################################################
        Route::post(
            '/sendMessage',
        ...
        Route::get(
            '/loadMessage/{reciever}/{sender}',
            [ContactsController::class, 'load']
        )->middleware('auth:coach');
        Route::get(
            '/retrieveMessages/{reciever}/{sender}/{lastMsgId}',
            [ContactsController::class, 'retrieveNew']
        )->middleware('auth:coach');
        #End Chat Route#
    }
);