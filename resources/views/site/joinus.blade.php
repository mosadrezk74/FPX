        ...
        <div class="col-xl-6">
          <div class="apply">
            ...
            <form class="form text-white"  method="post" action="{{route('join.store')}}"  >
             @csrf
                <input type="text" name="name" class="text-white" placeholder="اسمك" required>
                <input type="text" name="country" class="text-white" placeholder="الدولة" required>
                <input type="number" name="phone" class="text-white" placeholder="رقم الهاتف" required>
                <input type="text" name="email"  class="text-white" placeholder="البريد الالكتروني" required>
                <textarea rows="1" name="descr"   class="text-white"  placeholder="نص" required></textarea>
