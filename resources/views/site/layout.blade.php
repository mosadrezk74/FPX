...
<head>
    ...
    @if (App::getLocale() == 'ar')
        ...
        <link
            href="https://fonts.googleapis.com/css2?family=Cairo:wght@200..1000&family=IBM+Plex+Sans+Arabic:wght@100;200;300;400;500;600;700&family=Open+Sans:ital,wght@0,300..800;1,300..800&display=swap"
            rel="stylesheet">
    @else
        <link rel="preconnect" href="https://fonts.googleapis.com">
        <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    ...
    <div class="navbar">
        <div class="navbar_items">
            <ul class="herozintal_nav">
                <div class="offcanvas offcanvas-start ps-4" tabindex="-1" id="offcanvasExample"
                    aria-labelledby="offcanvasExampleLabel" style="background: #1e1e1e">
                    ...
                    <div class="offcanvas-body pe-0">
                        <div class="mt-5">
                            <ul class="vertical_nav">
                                ...
                                <li>
                                    <a href="{{ route('topRated') }}">{{ trans('site/index.topRated') }}</a>
                                </li>
                                ...
                                <hr />
                                <div class="dropdown">
                                    <button class="dropdown-toggle border-0 bg-transparent text-white verticalOne"
                ...
                <li class="verNavLinks">
                    <div class="dropdown">
                        <button class="dropdown-toggle border-0 bg-transparent text-white" type="button"
                            id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false">
                            {{ trans('site/index.discover') }}
                        </button>
                        <ul class="dropdown-menu py-3" aria-labelledby="dropdownMenuButton2"
                            style="background: #2a2a2a">
                            <li>
                                <a class="dropdown-item" href="{{ route('discover') }}">
                                    {{ trans('site/index.discover') }} </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('player') }}">
                                    {{ trans('site/index.players') }} </a>
                            </li>
                            <li>
                                <a class="dropdown-item"
                                    href="{{ route('clubs') }}">{{ trans('site/index.clubs') }}</a>
                            </li>
                            <li>
                                <a class="dropdown-item"
                                    href="{{ route('rating') }}">{{ trans('site/index.rating') }}</a>
                            </li>
                            <li>
                                <a class="dropdown-item"
                                    href="{{ route('scouting') }}">{{ trans('site/index.scout') }}</a>
                            </li>
                ...
                <li class="verNavLinks">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu py-3" aria-labelledby="dropdownMenuButton3"
                            style="background: #2a2a2a">
                            <li><a class="dropdown-item"
                                    href="{{ route('contact') }}">{{ trans('site/index.contact') }} </a></li>
                            <li>
                                <a class="dropdown-item"
                                    href="{{ route('join') }}">{{ trans('site/index.join') }}</a>
                            </li>
                ...
                <li class="searchParentLi">
                    <form action="{{ route('search') }}" method="GET">
                        ...
                        <button type="submit" class="searchBtn" style="display: none;">Search</button>
                    </form>
                </li>
                ...
                <div class="col-6 col-xl-5">
                    <div class="second">
                        ...
                        <p>
                            @if (App::getLocale() == 'ar')
                                <span>FPX</span>
                                إنها قاعدة بيانات تعاونية ويمكن لأي شخص إنشاء البيانات وتحريرها. تحتوي قاعدة البيانات
                                المجتمعية هذه على معلومات حول اللاعبين والأندية والملاعب والمديرين والحكام والدوريات
                                وغيرها من البيانات المتعلقة بعالم كرة القدم
                            @else
