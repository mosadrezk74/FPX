            ...
            <tbody>
                <tr>
                    @foreach ($players as $player)
                        ...
                        @if (App::getLocale() == 'en')
                            <td> <a href="{{ route('stats', [$player->name_en]) }}"
                                    style="text-decoration: none;color: white">{{ $player->name_en }}</a> </td>
                            <td>
                        ...
                        @else
                            <td> <a href="{{ route('stats', [$player->name_en]) }}"
                                    style="text-decoration: none;color: white">{{ $player->name_ar }}</a> </td>
                            <td>
                                <img src="{{ $player->club->image }}" style="width: 30px ; height: 30px " />
                                {{ $player->club->name_ar }}
                            </td>
