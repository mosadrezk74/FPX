...
@section('contact')
    {{-- <section class="players" id="players" style="border-radius: 10px;">
        ...
        <div class="playerB">
            ...
            <br>
            <input list="player2List" id="player2" name="player2" placeholder="{{ $player2->name_en }}"
                autocomplete="none" class="players_input">
            <datalist id="player2List" autocomplete="none">
                @foreach ($players as $player)
                    @if (App::getlocale() == 'ar')
                        <option value="{{ $player->name_ar }}">{{ $player->name_ar }}</option>
                    @else
    ...
    <section class="match">
        <div class="name_a"> <img src="{{ asset('site/images/comparison/Name A.png') }}" alt="name a"
                class="name_player"></div>
        <div class="name_b"> <img src="{{ asset('site/images/comparison/Name B.png') }}" alt="name b"
                class="name_player"></div>
    </section>
    ...
    <div class="ClassContianer1 ">
        ...
        <div class="total-shots" style="border-radius: 10px;">
            ...
            <img src="{{ asset('site/images/comparison/analysisPic.png') }}" alt="dataNumberOne"
                style="width: 100%;
        height: 85%;">
        </div>
                    ...
                    <table class="table-custom table-standings table-classic">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="team-inline">{{ intval($player1->stat->PasCrs * $player1->stat->MP) }}</td>
                ...
                <div class="table-container p-4 w-100">
                    <table class="table-custom table-standings table-classic ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><span>{{ trans('stat.Crs') }}</span></td>
                                <td class="team-inline">{{ intval($player2->stat->PasCrs * $player2->stat->MP) }}</td>
