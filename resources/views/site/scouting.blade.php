        ...
        <div class="heroContent">
            <div class="container">
                <div class="scoutingContent">
                    ...
                    <p>توفر نماذجنا أيضًا خيار تقييم أداء المدربين. ما هي الأنظمة التي استخدموها أكثر خلال مسيرتهم المهنية،
                        وما هي نسب الاستحواذ التي امتلكتها فرقهم، وكيف تصرفوا بشكل هجومي، وكيف أدوا دفاعيًا، بالإضافة إلى
                        الأمور المعقدة.</p>
                    ...
                    <div class="row px-5">
                        <div class="col-12 col-lg-6">
                            <div class="client-image">
                                <img class="img-fluid"
                                    src="{{ asset('site/images/scouting/Untitled video - Made with Clipchamp 1.png') }}" />

                                <div class="clubs">
                                    <div class="clubs-content1">
                                        <p>
                                            تعتمد بعض الأندية علينا لتحليل الفريق الذي سيواجهونه كل أسبوع. نقوم بتقييم
                                            الأسلوب والمقاييس الهجومية والدفاعية لهؤلاء الخصوم، وكيف يمكن لمهاجميهم
                                            المختلفين إيذائهم والعديد من التفاصيل الأخرى التي توفرها البيانات.
                                        </p>
                                    ...
                                    <div class="clubs-content2">
                                        <p>
                                            ليس لدينا فقط القدرة على قياس أداء اللاعب. نقوم أيضًا بتحليل مقاييس الفريق. نحن
                                            نحدد نقاط قوتهم، ونقاط ضعفهم، وطريقتهم في تحريك الكرة إلى الأمام، ومدى فعاليتهم
                                            في الكرات الثابتة أو كيفية تحسين متوسط الدوري الذي يتنافسون فيه. اكتشف قوة تحليل
                                            أداء فريق كرة القدم
                                        </p>
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="client-content">
                                <p>
                                    يمكن لعملائنا الحصول على معلومات آلية بطريقة مستقلة تمامًا لكل نادي، مع القدرة على تحليل
                                    الأداء واستخراج الاتجاهات وأسلوب اللعب والشكل ونقاط القوة والضعف.
                                    <span>Footy Prospect X </span>تم تصميمه بحيث يمكن لجميع ملفات تعريف الأقسام توفير الوقت
                                    واتخاذ قرارات أفضل.
                                </p>
                ...
                <div class="container">
                    <div class="scoutingContent">
                        ...
                        <p>Our models also offer the option of evaluating the performance
                            ...
                            defensively, as well as, complex trends</p>
