...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ trans('coach.coaches') }}</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/{{ trans('coach.veiw_all_coach') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                            ...
                            <tbody>
                                <tr>
                                    @foreach ($coaches as $coach)
                                        ...
                                        @if (App::getLocale() == 'ar')
                                            <td>
                                                <img src="{{ $coach->club->image }}" class="wd-30 ht-30" alt="img">
                ...
                <form action="{{ route('coach.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"
                            data-dismiss="modal">{{ trans('coach.close') }}</button>
