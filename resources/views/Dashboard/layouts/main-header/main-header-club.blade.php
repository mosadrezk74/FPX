        ...
        <div class="main-header-right">
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    @auth
                        <a class="profile-user d-flex" href="" data-toggle="dropdown" data-bs-dismiss="dropdown"><img alt="" src="{{Auth::user()->image}}"></a>
                    @else
                        <a class="profile-user d-flex" href="" data-toggle="dropdown" data-bs-dismiss="dropdown"><img alt="" src="{{asset('Dashboard/img/profile.jpg')}}"></a>
                    @endauth
                        ...
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user">
                                    @auth
                                        <img alt="" src="{{Auth::user()->image}}"></div>
                                @else
                                    <img alt="" src="{{asset('Dashboard/img/profile.jpg')}}"></div>
                            @endauth
