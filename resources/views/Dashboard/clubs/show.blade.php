                                ...
                                <div class=" tab-menu-heading">
                                    <div class="tabs-menu1">
                                        ...
                                        <ul class="nav panel-tabs main-nav-line">
                                            ...
                                            <li class="nav-item"><a href="#tab2" class="nav-link" data-toggle="tab">حراس المرمي</a>
                                            </li>
                                            <li class="nav-item"><a href="#tab3" class="nav-link" data-toggle="tab">المدافعين</a>
                                            </li>
                                            <li class="nav-item"><a href="#tab4" class="nav-link" data-toggle="tab">لاعبي الوسط
                                                    </a></li>
                                            <li class="nav-item"><a href="#tab5" class="nav-link" data-toggle="tab">المهاجمين</a>
                                            </li>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover text-md-nowrap text-center">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$club->Phone}}</td>
                                                        <td>{{$club->email}}</td>
                                                        <td>{{$club->Date_Birth}}</td>
                                                        <td>{{$club->Gender == 1 ? '`ذكر' :  'انثي'}}</td>
                                                        <td>{{$club->Blood_Group}}</td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                        ...
                                        <div class="tab-pane" id="tab4">
                                            <div class="table-responsive">
                                                <table class="table table-hover text-md-nowrap text-center" id="example1">
                                                    ...
                                                    <tbody>
                                                    @foreach($club_accounts as $club_account)
                                                        <tr>
                                                            <td>{{$loop->iteration}}</td>
                                                            <td>{{$club_account->date}}</td>
                                                            <td>
                                                                @if($club_account->single_invoice == true)
                                                                    {{$club_account->single_invoice->Service->name}}

                                                                @elseif($club_account->recipt_id == true)
{{--                                                                    {{$club_account->ReceiptAccount->description}}--}}

                                                                @elseif($club_account->Payment_id == true)
{{--                                                                    {{$club_account->PaymentAccount->description}}--}}
                                                                @endif

                                                            </td>
                                                            <td>{{ $club_account->Debit}}</td>
                                                            <td>{{ $club_account->credit}}</td>
                                                            <td></td>
                                                        </tr>
                                                        <br>
                                                    @endforeach
                                                    <tr>
                                                        ...
                                                        <td class="alert alert-primary">{{ number_format( $Debit = $club_accounts->sum('Debit'), 2) }}</td>
                                                        <td class="alert alert-primary">{{ number_format( $credit = $club_accounts->sum('credit'), 2) }}</td>
