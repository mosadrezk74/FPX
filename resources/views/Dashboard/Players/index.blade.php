            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <a href="{{ route('player.create') }}" class="btn btn-primary" role="button"
                        aria-pressed="true">{{ trans('player.create_player') }}</a>
                </div>
                                                ...
                                                <div class="tabs-menu1">
                                                    ...
                                                    <ul class="nav panel-tabs main-nav-line">
                                                        <li class="nav-item"><a href="#tab1" class="nav-link active"
                                                                data-toggle="tab">{{ trans('player.goalkeeper') }}</a></li>
                                                        <li class="nav-item"><a href="#tab2" class="nav-link"
                                                                data-toggle="tab">{{ trans('player.defender') }}</a></li>
                                                        <li class="nav-item"><a href="#tab3" class="nav-link"
                                                                data-toggle="tab">{{ trans('player.midfielder') }}</a></li>
                                                        <li class="nav-item"><a href="#tab4" class="nav-link"
                                                                data-toggle="tab">{{ trans('player.forward') }}</a></li>
                                                    </ul>
                                                </div>
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane active" id="tab1">
                                                        <div class="table-responsive">
                                                            <table
                                                                class="table table-hover text-md-nowrap text-center player-table"
                                                                data-position="0">
                                                                <thead>
                                                                    <tr>
                                                                        <th>#</th>
                                                                        ...
                                                                        @if ($player->position == 0)
                                                                            <tr>
                                                                                ...
                                                                                @if (App::getLocale() == 'ar')
                                                                                    ...
                                                                                    <td>
                                                                                        <a
                                                                                            href="{{ route('club.show', $player->club->id) }}">
                                                                                            {{ $player->club->name_ar }}</a>
                                                                                    </td>
                                                                                @else
                                                                                    <td>
                                                                                        <a
                                                                                    ...
                                                                                    <td>
                                                                                        <a
                                                                                            href="{{ route('club.show', $player->club->id) }}">
                                                                                            {{ $player->club->name_en }}</a>
                                                                                    </td>
                                                                                @endif
                                                                                <td> {{ $player->age_in_years }} </td>
                                                                                @if (App::getlocale() == 'ar')
                                                                                    <td>{{ $player->country->name_ar }}
                                                                                    </td>
                                                                                @else
                                                                                    <td>{{ $player->country->name_en }}
                                                                                    </td>
                                                                                @endif
                                                                                <td>
                                                                                    <form
